...
CREATE TABLE `__new_segments` (
	...
	CONSTRAINT "segments_type_ck" CHECK("__new_segments"."type" in ('flight','lodging','car','rail','activity','cruise','event','hotel','rental_car','note','todo','parking','boat','train','directions','food','poi','meetup','rideshare'))
);
